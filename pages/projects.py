...
def build_project(project):
  ...
  project['content'] = [format_content_segment(segment) for segment in project['content']]
...
def build():
  ...
  project_pages, project_info = zip(*[build_project(project) for project in project_json])
