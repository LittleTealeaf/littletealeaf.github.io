...
for snippet_path in conf.getFiles('markdown'):
    ...
    index['snippets'][stem] = Gen('markdown',stem).ref_json(Markdown.renderHash(snippet['content'],link_hrefa='https://github.com/LittleTealeaf/littletealeaf.github.io/tree/main/config/markdown/',link_src='https://raw.githubusercontent.com/LittleTealeaf/littletealeaf.github.io/main/config/markdown/'))
