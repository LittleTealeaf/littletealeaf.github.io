...
def resource_src(name='',ext=''):
    return resource(dir_gen_src,name,ext)

def resource_public(name='',ext=''):
    return resource(dir_gen_public,name,ext)
